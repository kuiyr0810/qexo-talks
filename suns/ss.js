...
(function (window, document) {
  ...
  const myQexoShouts = {
      ...
      container.innerHTML = `
        <section class="qexot" style="--qexot-label-color:${this._escapeAttr(this.config.labelColor)};--qexot-label-bg:${this._escapeAttr(this.config.labelColor)}1a;">
          <div class="xk-info qexot-info">
            <div class="count qexot-title" aria-label="${this._escapeAttr(this.config.title)} ${this.total}">
              <i class="iconfont icon-pinlun" aria-hidden="true"></i>
              <span class="qexot-title-text">${this._escapeHTML(this.config.title)}</span>
              <span class="qexot-title-count">「<span class="qexot-total">0</span>」</span>
            </div>
          </div>
        ...
        <article class="xk-card qexot-item wow animate__zoomIn" id="qexot-item-${id}" data-id="${id}">
          <header class="xk-card-header qexot-header">
            <div class="xk-card-name qexot-card-name">
              <div class="qexot-avatar-wrap" style="width:40px;height:40px;min-width:40px;min-height:40px;max-width:40px;max-height:40px;overflow:hidden;border-radius:50%;display:block;line-height:0;">
                <img class="qexot-avatar" src="${this._escapeAttr(this.config.avatar)}" alt="${this._escapeAttr(this.config.name)}" style="display:block;width:40px;height:40px;min-width:40px;min-height:40px;max-width:40px;max-height:40px;object-fit:cover;border-radius:50%;aspect-ratio:1/1;" onerror="this.style.display='none'">
              </div>
    ...
    _injectStyle() {
      ...
      style.textContent = `
.qexot{padding-bottom:40px}.qexot-info{display:flex;justify-content:space-between;align-items:center}.qexot-info .qexot-title{display:inline-flex;align-items:center;gap:6px;font-weight:900;font-size:30px;line-height:1.2;letter-spacing:.08em}.qexot-title-text,.qexot-title-count{display:inline-block;color:transparent;background:linear-gradient(90deg,#ff3d81,#ffb800,#28e98c,#2bd2ff,#7b61ff,#ff3d81);background-size:300% 100%;-webkit-background-clip:text;background-clip:text;animation:qexot-title-flow 3.5s linear infinite;text-shadow:0 0 18px rgba(123,97,255,.28)}.qexot-title .iconfont{color:#ff3d81;text-shadow:0 0 12px rgba(255,61,129,.45)}.qexot-total{font-size:34px;font-weight:1000}@keyframes qexot-title-flow{to{background-position:300% 0}}.qexot .xk-card,.qexot .qexot-item{padding:15px 20px 2px;border-radius:10px;background:rgba(255,255,255,.1);box-shadow:0 0 14px 2px rgb(7 17 27 / 6%);overflow:hidden;margin-top:20px;user-select:none;position:relative;transition:all .15s ease-in-out}.qexot .xk-card:hover,.qexot .qexot-item:hover{box-shadow:0 5px 10px 8px rgba(7,17,27,.16);transform:scale(1.015)}.qexot .xk-card-header,.qexot .qexot-header{display:flex;justify-content:space-between;align-items:center;gap:12px}.qexot .xk-card-header::before,.qexot .qexot-header::before{content:" ";width:4.5px;height:30px;background-color:var(--qexot-label-color);position:absolute;left:0;border-top-right-radius:5px;border-bottom-right-radius:5px;transition:height .2s ease}.qexot .xk-card:hover .xk-card-header::before,.qexot .qexot-item:hover .qexot-header::before{height:45px}.qexot .xk-card-name,.qexot .qexot-card-name{display:flex;align-items:center;min-width:0}.qexot .qexot-avatar-wrap{width:40px;height:40px;margin-right:10px;flex:0 0 auto;overflow:hidden;border-radius:50%}.qexot .qexot-avatar{display:block;width:100%;height:100%;object-fit:cover;border-radius:50%;box-shadow:0 0 3px 0 #00000066}.qexot .name-info,.qexot .qexot-user-info{display:inline-flex;flex-direction:column;align-items:flex-start;min-width:0}.qexot .name,.qexot .qexot-name{font-weight:bold;transition:letter-spacing .2s ease}.qexot .xk-card:hover .name,.qexot .qexot-item:hover .qexot-name{letter-spacing:1px}.qexot .xk-card-time,.qexot .qexot-datatime{font-size:12px;font-weight:400;font-style:oblique}.qexot-tags{display:flex;gap:6px;align-items:center;flex-wrap:wrap;justify-content:flex-end}.qexot .dao-label,.qexot .qexot-tag-item{color:var(--qexot-label-color);font-weight:bold;font-style:oblique;font-size:13px;background-color:var(--qexot-label-bg);padding:2px 6px;border-radius:.4em;text-decoration:none}.qexot .xk-card-content,.qexot .qexot-content{padding:.8rem 0;word-break:break-word}.qexot .xk-card-content img,.qexot .qexot-content img{cursor:zoom-in;max-width:100%;height:auto}.qexot .xk-card-content iframe,.qexot .qexot-content iframe{width:100%!important}.qexot .xk-card-footer,.qexot .qexot-bottom{display:flex;padding-bottom:10px;justify-content:flex-end;align-items:center}.qexot .dao-like,.qexot .qexot-like{margin-left:auto;display:inline-flex;align-items:center;gap:2px;border:0;background:transparent;padding:0;color:inherit;cursor:pointer;font:inherit}.qexot .xk-card-label>span::before,.qexot .qexot-from>span::before{content:" ";display:inline-block;width:14px;height:14px;margin-right:3px;vertical-align:middle;background-size:contain;background-position:center;background-repeat:no-repeat;background-image:url("data:image/png;base64,")}.qexot-like.is-liked{color:red}.qexot .like-svg{cursor:pointer}.qexot-loading{text-align:center;padding:20px}.qexot-loading img{width:282px;max-width:100%;height:auto}.bbddloading-inner{height:100px;margin:auto;position:relative;width:100px}.bbddloading-line-wrap{animation:spin 2000ms cubic-bezier(.175,.885,.32,1.275) infinite;box-sizing:border-box;height:50px;left:0;overflow:hidden;position:absolute;top:0;transform-origin:50% 100%;width:100px}.bbddloading-line{border:4px solid transparent;border-radius:100%;box-sizing:border-box;height:100px;left:0;margin:0 auto;position:absolute;right:0;top:0;width:100px}.bbddloading-line-wrap:nth-child(1){animation-delay:-50ms}.bbddloading-line-wrap:nth-child(2){animation-delay:-100ms}.bbddloading-line-wrap:nth-child(3){animation-delay:-150ms}.bbddloading-line-wrap:nth-child(4){animation-delay:-200ms}.bbddloading-line-wrap:nth-child(5){animation-delay:-250ms}.bbddloading-line-wrap:nth-child(1) .bbddloading-line{border-color:hsl(0,80%,60%);height:90px;width:90px;top:7px}.bbddloading-line-wrap:nth-child(2) .bbddloading-line{border-color:hsl(60,80%,60%);height:76px;width:76px;top:14px}.bbddloading-line-wrap:nth-child(3) .bbddloading-line{border-color:hsl(120,80%,60%);height:62px;width:62px;top:21px}.bbddloading-line-wrap:nth-child(4) .bbddloading-line{border-color:hsl(180,80%,60%);height:48px;width:48px;top:28px}.bbddloading-line-wrap:nth-child(5) .bbddloading-line{border-color:hsl(240,80%,60%);height:34px;width:34px;top:35px}@keyframes spin{0%,15%{transform:rotate(0)}100%{transform:rotate(360deg)}}.qexot-btn-area{text-align:center}.qexot .push-btn,.qexot .qexot-more{position:relative;isolation:isolate;overflow:hidden;min-width:148px;width:auto;padding:0 24px;font-size:16px;font-weight:800;letter-spacing:.08em;color:#fff;cursor:pointer;margin:20px;height:55px;text-align:center;border:2px solid #111;background:#111;border-radius:999px;box-shadow:0 10px 24px rgba(0,0,0,.18);transition:color .28s ease,transform .28s ease,box-shadow .28s ease}.qexot .push-btn::before,.qexot .qexot-more::before{content:"";position:absolute;inset:0;z-index:-2;background:repeating-linear-gradient(115deg,#000 0 12px,#fff 12px 24px);background-size:56px 56px;animation:qexot-more-roll 1.2s linear infinite}.qexot .push-btn::after,.qexot .qexot-more::after{content:"";position:absolute;inset:4px;z-index:-1;border-radius:inherit;background:#111;transition:background .28s ease}.qexot .push-btn:hover,.qexot .qexot-more:hover{color:#111;transform:translateY(-2px);box-shadow:0 14px 30px rgba(0,0,0,.26)}.qexot .push-btn:hover::after,.qexot .qexot-more:hover::after{background:#fff}.qexot .push-btn:active,.qexot .qexot-more:active{transform:translateY(0)}@keyframes qexot-more-roll{to{background-position:56px 0}}@media (prefers-reduced-motion:reduce){.qexot .push-btn::before,.qexot .qexot-more::before{animation:none}}.qexot-message{text-align:center;margin-top:20px}.qexot .xk-footer,.qexot .qexot-footer{width:100%;text-align:end;font-size:.75em;color:#999;margin-top:1em}.qexot-toast-box{position:fixed;top:1em;right:1em;z-index:9999;display:flex;flex-direction:column;gap:10px;pointer-events:none}.qexot-toast{min-width:260px;max-width:600px;padding:16px 20px;border-radius:8px;color:#fff;box-shadow:0 1px 10px rgba(0,0,0,.1);animation:qexot-toast-in .25s ease}.qexot-toast--success{background:#4caf50}.qexot-toast--error{background:#ff5252}.qexot-toast--default{background:#1976d2}@keyframes qexot-toast-in{from{opacity:0;transform:translateX(40px)}to{opacity:1;transform:none}}.view-image{position:fixed;inset:0;z-index:500;padding:1rem;display:flex;flex-direction:column;animation:view-image-in 300ms;backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px)}.view-image__out{animation:view-image-out 300ms}@keyframes view-image-in{0%{opacity:0}}@keyframes view-image-out{100%{opacity:0}}.view-image-container{height:0;flex:1;display:flex;align-items:center;justify-content:center}.view-image-lead{display:contents}.view-image-img{position:relative;z-index:1;max-width:100%;max-height:100%;object-fit:contain;border-radius:3px}.view-image-close__full{position:absolute;inset:0;background-color:rgba(48,55,66,.3);z-index:unset;cursor:zoom-out;margin:0;border:0}.view-image-tools{position:absolute;bottom:5%;left:1rem;right:1rem;max-width:600px;margin:0 auto;padding:10px;border-radius:5px;background:rgba(255,255,255,.1);backdrop-filter:blur(10px);z-index:1;display:flex;justify-content:space-between;align-items:center;color:#fff}.view-image-tools__count{width:60px;display:flex;align-items:center;justify-content:center}.view-image-tools__flip{display:flex;gap:10px}.view-image-btn{width:32px;height:32px;display:flex;justify-content:center;align-items:center;cursor:pointer;border:0;border-radius:3px;background-color:rgba(255,255,255,.2);color:#fff}.view-image-btn:hover{background-color:rgba(255,255,255,.5)}@media screen and (min-width:768px){.qexot .xk-card-content .fancybox,.qexot .xk-card-content video,.qexot .qexot-content .fancybox,.qexot .qexot-content video{display:inline-block;max-width:50%}}@media screen and (max-width:768px){.qexot .xk-card-content .fancybox,.qexot .xk-card-content video,.qexot .qexot-content .fancybox,.qexot .qexot-content video{display:inline-block;max-width:100%}.qexot .qexot-header{align-items:flex-start}.qexot .qexot-tags{max-width:45%;justify-content:flex-end}.qexot-info .qexot-title{font-size:24px}.qexot-total{font-size:28px}.qexot-toast-box{left:0;right:0;top:0}.qexot-toast{border-radius:0;max-width:none}}
      `;
